#!/usr/bin/env python3
"""Scan the Cartenza derived affinity package for restricted naming terms."""
...
TARGETS = [
    ROOT / "derived_affinity_substrate_v0_1",
    ROOT / "scripts" / "build_derived_affinity_substrate_v0_1.py",
]
