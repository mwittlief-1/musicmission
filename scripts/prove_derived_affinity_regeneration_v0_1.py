#!/usr/bin/env python3
"""Regenerate the Cartenza derived affinity package and compare file hashes."""
...
BUILDER = ROOT / "scripts" / "build_derived_affinity_substrate_v0_1.py"
...
def main() -> int:
    ...
    if result.returncode != 0:
        print(f"FAIL regeneration command_exit={result.returncode}")
